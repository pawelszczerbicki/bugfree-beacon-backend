curl -XPOST -H "Content-type: application/json" bejkon.herokuapp.com/customer/ -d '
{
...
curl -XPOST -H "Content-type: application/json" http://bejkon.herokuapp.com/customer/ -d '
{
  "name": "BIGBUT",
...
curl -XPOST -H "Content-type: application/json" http://bejkon.herokuapp.com/beacon -d '
{
